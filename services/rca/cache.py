...
тревогой при заполнении (ADR-0032, Часть A завершающая; книга Биркина, глава 17.5).
Пригоден, например, для кэша baseline анализатора, чтобы не запрашивать хранилище
логов на каждый разбор. Часы инъектируемы для детерминированной проверки.
"""
